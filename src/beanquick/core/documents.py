...
from beanquick.helpers import FavaAPIError
...
def is_document_or_import_file(filename: str, ledger: BeanquickLedger) -> bool:
    """Check whether the filename is a document or in an import directory.

    Args:
        filename: The filename to check.
        ledger: The BeanquickLedger.
    ...
    return any(
        ...
        for d in ledger.beanquick_options.import_dirs
    )
