...
from beanquick.core.query import COLUMNS
from beanquick.core.query import ObjectColumn
from beanquick.core.query import QueryResultTable
from beanquick.core.query import QueryResultText
from beanquick.helpers import BeanquickError
from beanquick.util.excel import HAVE_EXCEL
from beanquick.util.excel import to_csv
from beanquick.util.excel import to_excel
...
class FavaShellError(BeanquickError):
...
class QueryShell(FavaModule):
    ...
    def execute_query_serialised(
        ...
        Raises:
            BeanquickError: If the query response is an error.
        """
    ...
    def query_to_file(
        ...
        Raises:
            BeanquickError: If the result format is not supported or the
            query failed.
        """
        name = "query_result"
